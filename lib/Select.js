...
Select.propTypes = {
	...
	eventComesFromMenu: _propTypes2.default.func, // eventComesFromMenu: function (event) {return true;}. Optional function for deciding if touchstart event is on the select component or not
